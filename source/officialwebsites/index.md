...
**Immigration, Refugees and Citizenship Canada (IRCC)** is responsible for immigration, refugees, and citizenship services in Canada.
...
- header: "{fas}`clock;pst-color-primary` Processing Times"
  content: "View the processing times for various applications."
  link: https://www.canada.ca/en/immigration-refugees-citizenship/services/application/check-processing-times.html

- header: "{fas}`file-alt;pst-color-primary` IRCC Forms"
  content: "Find forms and guides for various applications."
...
## ATIP Related Services

**Access to Information and Privacy (ATIP)** requests allow individuals to access personal information held by government institutions.

```{gallery-grid}
:grid-columns: 1 2 2 3

- header: "{fas}`file-signature;pst-color-primary` IRCC ATIP Request"
  content: "Request your personal information from IRCC."
...
**Express Entry** is a fast-track immigration system for skilled workers, professionals, and international students.
...
**The Provincial Nominee Program (PNP)** allows Canadian provinces and territories to nominate individuals for immigration based on their specific economic needs.
...
Here are some **additional resources** that might be important for newcomers to Canada.

```{gallery-grid}
:grid-columns: 1 2 2 3

- header: "{fas}`book;pst-color-primary` Settlement Services"
  content: "Find services to help you adjust to life in Canada."
  link: https://www.cic.gc.ca/english/newcomers/services/index.asp

- header: "{fas}`briefcase;pst-color-primary` Job Bank"
  content: "Search for jobs in Canada and explore career opportunities."
  link: https://www.jobbank.gc.ca/home

- header: "{fas}`university;pst-color-primary` Educational Credential Assessment"
  content: "Get your educational credentials assessed for immigration."
...
- header: "{fas}`clinic-medical;pst-color-primary` Healthcare in Canada"
  content: "Information on Canada's healthcare system and provincial health insurance."
